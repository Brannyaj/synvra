        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              At Synvra, our mission is to empower businesses through innovative software solutions. We believe in creating technology that not only solves problems but also drives growth and enhances user experiences. Our commitment to excellence, transparency, and continuous innovation sets us apart in the industry.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600">We maintain the highest standards in code quality, security, and user experience.</p>
            </div>
          </motion.div>
        </div>
      </div>
