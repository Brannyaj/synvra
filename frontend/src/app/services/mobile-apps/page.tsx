      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          <div className="text-center mb-16">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Mobile App Development</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Create stunning mobile experiences that engage users and drive business growth
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {[
              ...
              {
                title: "UI/UX Design",
                description: "Beautiful, intuitive interfaces following platform guidelines",
                icon: (
                  <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" />
                  </svg>
          ...
          <div className="bg-gray-100 rounded-2xl p-8 mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
              {[
                ...
                "React Native", "Flutter", "Firebase", "GraphQL",
                "Node.js", "MongoDB", "AWS", "Google Cloud"
              ].map((tech, index) => (
                <motion.div
                  key={tech}
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8">
              Let's create an exceptional mobile experience for your users
            </p>
            <a
              href="/quote"
