      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <div className="bg-white rounded-2xl p-8 mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Cloud Providers We Work With</h2>
          ...
          {/* Benefits */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Why Choose Our Cloud Solutions?</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                {
                  title: "Cost Optimization",
                  description: "Reduce infrastructure costs with optimized cloud resources and pay-as-you-go models."
                },
                {
                  title: "Scalability",
                  description: "Scale your applications seamlessly to handle any workload."
                },
                {
                  title: "Security",
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8">
              Let's discuss how we can help you leverage the power of cloud computing
            </p>
            <a
              href="/contact"
