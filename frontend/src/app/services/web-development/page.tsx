      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          <div className="text-center mb-16">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Web Development Services</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Create powerful, scalable, and beautiful web applications with our expert development team
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Tailored solutions built to your exact specifications using cutting-edge technologies",
                icon: (
              ...
              },
              {
                ...
                description: "Fast, responsive applications that work offline and feel native",
                icon: (
                  <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
